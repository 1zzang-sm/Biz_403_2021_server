 ...
 * 
 *	DB와 연동되는 프로젝트는 1개의 table마다 서비스가 만들어지는데,
 *	<CRUD> 를 최소한 구현해야 한다.
 */
public interface BookService {
	
	/*
	 * WEB Browser에서 데이터를 보내면 Controller에서 데이터를 전달받고 
	...
	/*
	 * 변경하고자 하는 데이터를 전달받아서
	 * 	( 전달받은 데이터에는 반드시 PK값이 포함되어 있어야한다)
	 *  PK로 조건을 설정하고 데이터를 UPDATE 한다.
	 */
