...
public class MyPageController extends HttpServlet{
	...
	private static final long serialVersionUID = 3863284776466157461L;
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// utf8 로 요청받고 Encoding UTF-8로 요청을 받고 문자열데이터를 사용해야 글자깨짐이 없다.
		...
		resp.setContentType("text/html;charset=UTF-8"); // utf8 응답해준다 보여준다 
