...
<%-- jsp주석
 ...
 standard TagLib
	 ...
	 Jst 2.0 이상에서 사용가능, Tomcat 5.5 이상에서 사용가능
...
<body>
	...
	<c:forEach items="${BUYERS}" var="BUYER"> 
		<p>${BUYER.bu_code },<a href="page2?bu_code=${BUYER.bu_code }"></a> ${BUYER.bu_name },${BUYER.bu_tel }, ${BUYER.bu_addr}
	</c:forEach>
</body>
</html>